    ...
    <section className='bg-black pb-52' id="features">
      <div className='container mx-auto px-3 md:px-19'>
        <div className='px-5 py-32'>
            ...
            <p className='max-w-md text-blue-50 opacity-50 font-circular-web text-lg'>Immerse yourself in a rich and ever-expanding universe where a vibrant array of products converge into an interconnected overlay experience on your world</p>
        </div>
